<div class="row bg-dark-lighten">
    <div class="col-sm-12 button-list " style="padding: 1em;">
        <a href="#" class="btn btn-icon btn-light"> <i class="fas fa-plus"></i> </a>
        <a href="#" class="btn btn-icon btn-success"> <i class="fas fa-sync-alt"></i> </a>
        ...
        <a href="/" class="btn btn-icon btn-primary float-right"><i class="fas fa-home"></i></a>
    </div>
</div>
