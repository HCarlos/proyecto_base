<div class="form-group has-error row mb-3">
    ...
    <div class="col-md-9">
        <input type="text" name="beca_sep" id="beca_sep" value="{{ old('beca_sep',$items->user_becas->beca_sep) }}" class="form-control" />
    ...
    <div class="col-md-9">
        <input type="text" name="beca_arji" id="beca_arji" value="{{ old('beca_arji',$items->user_becas->beca_arji) }}" class="form-control" />
    ...
    <div class="col-md-9">
        <input type="text" name="beca_spf" id="beca_spf" value="{{ old('beca_spf',$items->user_becas->beca_spf) }}" class="form-control" />
    ...
    <div class="col-md-9">
        <input type="text" name="beca_bach" id="beca_bach" value="{{ old('beca_bach',$items->user_becas->beca_bach) }}" class="form-control" />
